...
//!
//! NOTE: These tests are designed for 48kHz mode only. At 8kHz, FFT resolution
//! is too low, RNNoise requires 48kHz, and bandwidth constraints prevent
//! many channel simulations from working. Skip at 8kHz.
